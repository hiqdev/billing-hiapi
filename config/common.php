...
$singletons = [
    ...
    \hiqdev\DataMapper\Hydrator\ConfigurableHydrator::class => [
        'hydrators' => [
            ...
            \hiqdev\php\billing\bill\BillInterface::class       => \hiqdev\billing\hiapi\bill\BillHydrator::class,
            ...
            \hiqdev\php\billing\statement\StatementBill::class  => \hiqdev\billing\hiapi\statement\StatementBillHydrator::class,
            \hiqdev\php\billing\statement\StatementBillInterface::class  => \hiqdev\billing\hiapi\statement\StatementBillHydrator::class,
            ...
            \hiqdev\php\billing\type\TypeInterface::class       => \hiqdev\billing\hiapi\type\TypeHydrator::class,
    ...
    \hiapi\jsonApi\ResourceDocumentFactory::class => [
        '__construct()' => [
            'resourceMap' => [
                ...
                \hiqdev\billing\hiapi\plan\PlanReadModel::class         => \hiqdev\billing\hiapi\plan\PlanReadModelResource::class,
            ],
        ],
    ],
